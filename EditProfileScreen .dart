...
//EditProfileScreen  after Refactoring ******
              ...
              children: [
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: InkWell(
                          ...
                          child:
                              Icon(Icons.edit, color: AppColors.kWhiteColor),
                        ),
                      ),
                    ],
                  ),
                ...
                BlocBuilder<LayoutCubit, LayoutStates>(
                  buildWhen: (past, current) =>
                      current is ChangeGenderStatusState,
                  builder: (context, state) {
