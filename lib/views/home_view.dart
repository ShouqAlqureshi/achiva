    ...
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          ...
          //Leave goal button
          /* : ElevatedButton(
                  //Call Leave goal method
                  onPressed: () async {
                    _leaveGoal(context, goalRef);
                  },
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets
                        .zero, // Remove default padding for the button
                    shape: RoundedRectangleBorder(
                      borderRadius:
                  ...
                  child: Ink(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Color.fromARGB(255, 21, 4, 97),
                          Color.fromARGB(255, 66, 8, 201),
                        ], // Define the gradient colors
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                      ),
...
//Leave goal method
 /* void _leaveGoal(BuildContext context, DocumentReference goalRef) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
            ...
            TextButton(
              ...
              onPressed: () async {
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('You leaved successfully')),
                  );
                  Navigator.of(context).pop(); // Close both dialogs
                } catch (e) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Error Leaving goal: $e')),
                  );
                }
              },
            ),
