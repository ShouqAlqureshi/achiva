...
class _DeleteAccountScreenState extends State<DeleteAccountScreen> {
  ...
  Future<void> _deleteAccount() async {
    ...
    try {
      ...
      String? userPhoneNumber = user.uid;

      if (userPhoneNumber == null) {
        throw Exception("Phone number not found for the logged-in user.");
      }

      // Delete the user document from Firestore
      DocumentReference userDocRef = FirebaseFirestore.instance
          .collection('Users')
          .doc(userPhoneNumber); // Use user.uid if using UIDs
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.red, // Set button color to red for warning
                    ),
